...
- `mvc/models/user_model.py` : `load_user_by_login`, le loader SQL du socle `users` ;
...
Le loader `load_user_by_login` est **importé depuis `mvc/models/user_model.py`** : le SQL vit dans le modèle, jamais dans le contrôleur.
