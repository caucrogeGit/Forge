"""Garde-fou STARTER-STATS-ADMIN-SQL-001 — palier 1 avancé welcome-stats (slot 106)."""
...
def test_resolves():
    ...
    assert m["id"] == "stats-admin-sql" and m["number"] == 106
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("stats-admin-sql", "stats_admin_sql", "106"):
