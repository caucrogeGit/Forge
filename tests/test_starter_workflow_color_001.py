"""Garde-fou STARTER-WORKFLOW-COLOR-001 — palier 2 avancé welcome-workflow (slot 92)."""
...
def test_resolves():
    ...
    assert m["id"] == "workflow-color" and m["number"] == 92
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("workflow-color", "workflow_color", "92"):
