...
Sécurité :
    Si FORGE_TEST_DB_NAME ne commence pas par "forge_e2e_", les tests refusent de
...
def _scaffold_project(root: Path) -> None:
    ...
    _write(
        ...
        "os.environ['DB_HOST'] = os.environ.get('FORGE_TEST_DB_HOST', '127.0.0.1')\n"
        "os.environ['DB_PORT'] = os.environ.get('FORGE_TEST_DB_PORT', '3306')\n"
