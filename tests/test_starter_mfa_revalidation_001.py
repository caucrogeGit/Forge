"""Garde-fou STARTER-MFA-REVALIDATION-001 — palier 1 avancé welcome-mfa (slot 79)."""
...
def test_resolves():
    ...
    assert m["id"] == "mfa-revalidation" and m["number"] == 79
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("mfa-revalidation", "mfa_revalidation", "79"):
