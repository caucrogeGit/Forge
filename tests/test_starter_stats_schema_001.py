"""Garde-fou STARTER-STATS-SCHEMA-001 — palier 3 débutant welcome-stats (slot 102)."""
...
def test_resolves():
    ...
    assert m["id"] == "stats-schema" and m["number"] == 102
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("stats-schema", "stats_schema", "102"):
