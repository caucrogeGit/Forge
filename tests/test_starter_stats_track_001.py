"""Garde-fou STARTER-STATS-TRACK-001 — palier 2 intermédiaire welcome-stats (slot 104)."""
...
def test_resolves():
    ...
    assert m["id"] == "stats-track" and m["number"] == 104
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("stats-track", "stats_track", "104"):
