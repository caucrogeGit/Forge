"""Garde-fou STARTER-RBAC-WELCOME-001 — palier 1 débutant welcome-rbac (slot 82)."""
...
def test_resolves():
    ...
    assert m["id"] == "rbac-welcome" and m["number"] == 82
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("rbac-welcome", "rbac_welcome", "82"):
