"""Garde-fou STARTER-MFA-RECOVERY-001 — palier 3 intermédiaire welcome-mfa (slot 78)."""
...
def test_resolves():
    ...
    assert m["id"] == "mfa-recovery" and m["number"] == 78
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("mfa-recovery", "mfa_recovery", "78"):
