"""OPTIN-DDL-SESSIONS-DB-001 (MariaDB) — la migration rendue s'exécute.
...
`INDEX` en ligne : il ne passait QUE sur MariaDB ; ce garde-fou verrouille la non-régression.
...
def test_migration_rendue_sexecute_et_la_table_est_utilisable(real_db: None) -> None:
