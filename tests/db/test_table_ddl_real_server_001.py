"""DB-TABLE-DDL-RENDERER-001 (MariaDB) — le DDL rendu s'exécute vraiment.
...
Marqué `db` : sauté sans serveur, requis en CI via
FORGE_REQUIRE_DB=1. Noms de tables générés (uuid).
"""
...
def test_table_sans_identite_sexecute_et_accepte_une_ligne(real_db: None) -> None:
...
def test_table_avec_identite_horodatages_et_fk(real_db: None) -> None:
