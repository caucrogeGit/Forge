"""DB-TABLE-DDL-RENDERER-001 (SQL Server) — le DDL rendu s'exécute vraiment.
...
def test_table_sans_identite_sexecute_et_accepte_une_ligne(real_mssql_db: None) -> None:
...
def test_table_avec_identite_horodatages_et_fk(real_mssql_db: None) -> None:
