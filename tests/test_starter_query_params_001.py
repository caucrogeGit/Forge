...
- enregistré avec id "query-params" et number 2 ;
...
class TestQueryParamsStarterMetadata:
    ...
    def test_number_est_2(self):
        assert resolve("query-params")["number"] == 2
    ...
    @pytest.mark.parametrize("alias", ["query_params", "params", "2"])
