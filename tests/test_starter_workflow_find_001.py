"""Garde-fou STARTER-WORKFLOW-FIND-001 — palier 3 débutant welcome-workflow (slot 87)."""
...
def test_resolves():
    ...
    assert m["id"] == "workflow-find" and m["number"] == 87
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("workflow-find", "workflow_find", "87"):
