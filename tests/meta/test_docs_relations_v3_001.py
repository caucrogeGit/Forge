"""Garde-fous DOCS-RELATIONS-MD-REFRESH-001 : cohérence de docs/relations.md avec Forge 3.0.
...
RELATIONS_PATH = PROJECT_ROOT / "docs" / "relations.md"
...
class TestRelationsMdNoStaleForgeVersion:
    ...
    def test_file_exists(self):
        assert RELATIONS_PATH.exists(), "docs/relations.md introuvable"
    ...
    def test_no_stale_current_state_1_5_0(self):
        ...
        assert "tel qu'il existe dans Forge 1.5.0" not in text, (
            "docs/relations.md présente encore Forge 1.5.0 comme version actuelle — "
    ...
    def test_no_forge_v1_as_framework_qualifier(self):
        ...
        assert "Forge V1" not in text, (
            "docs/relations.md utilise 'Forge V1' comme qualificatif de version du framework — "
...
class TestRelationsMdFormatVersionLegitimate:
    ...
    def test_format_version_still_present(self):
        ...
        assert "format_version" in text, (
            "docs/relations.md doit toujours documenter le champ format_version "
