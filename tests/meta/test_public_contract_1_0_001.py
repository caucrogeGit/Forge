...
class TestStartersFrozen:
    FROZEN = {
        ...
        "welcome-optin-video", "list-records", "filter-list", "pagination", "layout-template", "update-record", "delete-record", "session-state",
    }
...
class TestContractDocumented:
    ...
    @pytest.mark.parametrize("needle", [
        ...
        "24 starters", "mkdocs build --strict",
    ])
