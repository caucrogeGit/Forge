...
class TestStartersFrozen:
    FROZEN = {
        ...
        "welcome-optin-video", "list-records", "filter-list", "pagination", "layout-template", "update-record", "delete-record",
    }
...
class TestContractDocumented:
    ...
    @pytest.mark.parametrize("needle", [
        ...
        "23 starters", "mkdocs build --strict",
    ])
