...
EXPECTED_DOC_PATHS = [
    ...
    "workflow/reference",
    "stats/reference",
    "files/welcome/debutant/files-welcome",
    "images/welcome/debutant/images-welcome",
    "iot/welcome/debutant/iot-welcome",
    "video/welcome/debutant/video-welcome",
    "audio/welcome/debutant/audio-welcome",
    "mail/welcome/debutant/mail-welcome",
    "entities/welcome/debutant/entity-welcome",
    # Section Starters (13 cartes de progression)
    "starters/welcome-forge/debutant/welcome",
    "mfa/welcome/debutant/mfa-welcome",
    "rbac/welcome/debutant/rbac-welcome",
    "workflow/welcome/debutant/workflow-welcome",
    "stats/welcome/debutant/stats-welcome",
...
class TestLandingArticlesClickable:
    ...
    def test_all_articles_are_wrapped_in_links(self):
        ...
        # ajoute ou retire une carte (ici : +1 carte module forge-mvc-fixtures
        # dans la grille des modules officiels, alignée sur les autres opt-ins).
        expected = 71
