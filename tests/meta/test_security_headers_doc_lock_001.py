...
- docs/security.md mentionne les en-tetes de securite ;
    ...
    def test_doc_ne_promet_pas_securite_complete(self):
        ...
        for phrase in forbidden:
            assert phrase not in text, (
                f"docs/security.md ne doit pas promettre une securite complete : {phrase!r}."
            )
