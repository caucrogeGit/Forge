"""Tests documentaires — STARTER-WELCOME-IMPORT-EXPORT-NAV-001.

Verrouille la navigation pédagogique de la progression `welcome-import-export`
(module opt-in `forge-mvc-import-export`, 3 niveaux) : chaînage, bilans, et
...
WELCOME = PROJECT_ROOT / "packages" / "forge-mvc-import-export" / "docs" / "welcome"
...
class TestPagesExist:
    @pytest.mark.parametrize(
        ...
        [
            "recapitulatif.md",
            "debutant/import-welcome.md",
            "debutant/import-read.md",
            "debutant/bilan.md",
            "intermediaire/import-validate.md",
            "intermediaire/import-coerce.md",
            "intermediaire/bilan.md",
            "avance/import-partial.md",
            "avance/export-tocsv.md",
            "avance/import-independance.md",
            "avance/bilan.md",
        ],
    )
