...
class TestSecurityLabels:
    ...
    def test_rbac_label_is_security(self, tmp_path):
        from forge_cli.doctor import check_rbac_dependency
...
class TestCheckRbacDependencyExposed:
    ...
    def test_detect_rbac_indicators_importable(self):
        from forge_cli.doctor import _detect_rbac_indicators
...
def _read(name):
    """Importe paresseusement un symbole de forge_cli.doctor par son nom."""
    import forge_cli.doctor as _doctor
