...
OPTIN_MODULES: dict[str, set[str]] = {
    ...
    # importés (binaires système, runners injectés), donc pas d'extra à lister.
    "forge_mvc_audio": set(),
    # forge-mvc-admin : opt-in. Ses tests gardent l'import via
    # pytest.importorskip("forge_mvc_admin"). Aucune dépendance d'extra : le
    # back-office n'emploie que le cœur et sa couche d'accès BDD.
    "forge_mvc_admin": set(),
