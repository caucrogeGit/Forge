...
class TestSectionOrder:
    ...
    def test_latest_at_top_after_header(self):
        ...
        for candidate in ["## [Non publié]", "## [1.0.0-rc.1]", "## [1.0.0-beta.17]", "## [1.0.0-beta.16]", "## [1.0.0-beta.15]", "## [1.0.0-beta.14]", "## [1.0.0-beta.13]", "## [1.0.0-beta.12]", "## [1.0.0-beta.11]", "## [1.0.0-beta.10]", "## [1.0.0-beta.9]", "## [1.0.0-beta.8]", "## [1.0.0-beta.7]", "## [1.0.0-beta.6]", "## [1.0.0-beta.5]", "## [1.0.0-beta.4]"]:
