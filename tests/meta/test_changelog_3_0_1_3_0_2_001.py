...
class TestSectionOrder:
    ...
    def test_latest_at_top_after_header(self):
        ...
        for candidate in ["## [1.0.0-beta.13]", "## [1.0.0-beta.12]", "## [1.0.0-beta.11]", "## [1.0.0-beta.10]", "## [1.0.0-beta.9]", "## [1.0.0-beta.8]", "## [1.0.0-beta.7]", "## [1.0.0-beta.6]", "## [1.0.0-beta.5]", "## [1.0.0-beta.4]"]:
