"""Garde-fou PIVOT-TYPING-STRICT-GUARD-001 : forge-mvc-pivot reste strict + typé.

Quatrième opt-in passé en pyright strict (suite du cliquet ADR-036, après le
cœur, ``forge-mvc-files``, ``forge-mvc-images`` et ``forge-mvc-mail``). Ce test
