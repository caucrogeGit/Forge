"""Garde-fou STARTER-RBAC-USER-ROLE-001 — palier 1 avancé welcome-rbac (slot 88)."""
...
def test_resolves():
    ...
    assert m["id"] == "rbac-user-role" and m["number"] == 88
    assert m.get("requires_db") is False


def test_aliases():
    for a in ("rbac-user-role", "rbac_user_role", "88"):
