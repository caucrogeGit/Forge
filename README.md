...
`images`, `audio`, `video`, `iot`, `pivot`, `mail`, `i18n`, `qrcode`, `settings`, `import-export`) s'installent
...
`forge-mvc-settings` et `forge-mvc-import-export` ne sont pas encore publiés sur PyPI ; ils s'installent en éditable via
