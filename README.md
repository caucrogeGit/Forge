...
`images`, `audio`, `video`, `iot`, `pivot`, `mail`, `i18n`, `qrcode`, `settings`, `import-export`, `audit`) s'installent
...
`forge-mvc-settings`, `forge-mvc-import-export` et `forge-mvc-audit` ne sont pas encore publiés sur PyPI ; ils s'installent en éditable via
