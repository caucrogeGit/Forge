...
`images`, `audio`, `video`, `iot`, `pivot`, `mail`, `i18n`, `qrcode`, `settings`, `import-export`, `audit`, `jobs`) s'installent
...
`forge-mvc-settings`, `forge-mvc-import-export`, `forge-mvc-audit` et `forge-mvc-jobs` ne sont pas encore publiés sur PyPI ; ils s'installent en éditable via
