...
Récapitulatif des compétences acquises au **niveau intermédiaire** de la progression *Welcome Vidéo*.
Ce niveau fait passer de la lecture à une petite chaîne **alimenter → servir → suivre**, toujours sans transcodage.
...
Vous savez maintenant enregistrer une vidéo, la servir en streaming et suivre son cycle de vie, sans transcodage.

## Et ensuite

Place au **niveau avancé** : on bascule vers le réel, avec la sonde ffprobe, le transcodage ffmpeg et le diagnostic du module.
