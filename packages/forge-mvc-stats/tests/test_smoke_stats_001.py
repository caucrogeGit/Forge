"""Smoke test du paquet forge-mvc-stats (OPTIN-SMOKE-TESTS-001).
...
ET en autonome (`cd packages/forge-mvc-stats && pytest`). Skip propre si le
paquet n'est pas installé (convention `pytest.importorskip` du projet).
"""
