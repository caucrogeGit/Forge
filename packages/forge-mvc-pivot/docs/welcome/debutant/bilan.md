...
Récapitulatif du **niveau débutant** de la progression *Bonjour Forge Pivot*. Ce
...
|--------|--------------------|
| 1 — [Bonjour Forge Pivot](pivot-welcome.md) | Distinguer pivot ordinaire et pivot enrichi ; construire un `PivotAdvancedService`. |
...
Vous comprenez l'enjeu du pivot enrichi et son stockage à SQL visible.
