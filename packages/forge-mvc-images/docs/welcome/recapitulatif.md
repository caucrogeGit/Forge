...
!!! note "Module opt-in"
    ...
    Le paquet dépend de `forge-mvc-files` et il est publié sur PyPI depuis `1.0.0-beta.13` (`pip install --pre forge-mvc-images` en tête de parcours).
...
|---|--------|------------------|---------|
| 1 | [Welcome Images](debutant/images-welcome.md) | Vérifier le module, inspecter formats et préréglages de variantes | `ALLOWED_IMAGE_EXTENSIONS`, `variant_presets` |
