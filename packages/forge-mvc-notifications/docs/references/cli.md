...
La table `notifications` n'est pas créée automatiquement : l'écriture en base reste explicite (principe 3, SQL visible).
`forge notifications:init` copie la migration SQL embarquée dans le dossier `mvc/migrations/` du projet.
