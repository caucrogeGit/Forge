...
|--------|--------------------|
| 1, [Import partiel](import-partial.md) | « Tout ou rien » par défaut, `partial=True`, capture des erreurs d'insertion. |
...
[Référence du moteur d'import](../../references/engine.md)
