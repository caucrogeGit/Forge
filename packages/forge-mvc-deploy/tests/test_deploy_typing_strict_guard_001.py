"""Garde-fou DEPLOY-TYPING-STRICT-GUARD-001 : forge-mvc-deploy strict + typé.
...
import forge_mvc_deploy  # noqa: E402
...
def test_tout_forge_mvc_deploy_est_pyright_strict() -> None:
    missing: list[str] = []
...
def test_py_typed_present() -> None:
    assert (PKG_ROOT / "py.typed").is_file(), "forge_mvc_deploy doit embarquer py.typed (PEP 561)"
