...
Ce niveau pose les bases : comprendre l'opt-in et générer les fichiers de
déploiement.
...
Vous savez générer les fichiers de déploiement sans toucher à votre code
applicatif.

## Et ensuite

Place au niveau **intermédiaire** : vérifier l'environnement de production avec
`forge deploy:check`, lire les tags de résultat et adapter les gabarits.
