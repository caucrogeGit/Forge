...
Ce niveau ajoute la vérification de l'environnement et l'adaptation des
gabarits.
...
Vous savez diagnostiquer l'environnement de production et personnaliser les
fichiers générés.

## Et ensuite

Place au niveau **avancé** : la notion d'opt-in CLI-only et l'indépendance du
cœur vis-à-vis de l'outillage de déploiement.
