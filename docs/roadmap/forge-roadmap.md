...
`TEST-DOC-AS-TEST-ROTATION-002` : 1re tranche livrée (suppression de `test_landing_beta12_highlights_001` et des classes de prose de `test_landing_post_2_2_refresh`, messages de `test_docs_no_stale_versions_001` actualisés) ; la rotation reste un chantier continu. Restent aussi les 7 ⚪ Faible.
