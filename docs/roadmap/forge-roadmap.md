...
| `GOV-CLAUDE-MD-OPTINS-RESYNC-001` | Resync `CLAUDE.md` (§1, §3, §9 « 12 sous-dossiers/opt-ins » → 15 : admin, testing, qrcode ; tableau ADR §4 jusqu'à 050). Fichier protégé par le hook → mainteneur, au prochain tag. Complète `GOV-DOC-COHERENCE-001` | ⚪ ⏸ mainteneur (au tag) |
