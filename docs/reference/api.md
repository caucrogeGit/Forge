...
appartiennent désormais aux modules d'upload et de mail optionnels,
...
`list_media_for_entity` pour les galeries. Les imports du module médias optionnel sont
...
- **Contrôleur `create`** :
  - Import des helpers d'upload générique (fichiers non-image) et image-aware depuis les modules d'upload et de médias optionnels.
