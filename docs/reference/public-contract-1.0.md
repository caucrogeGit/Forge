...
## 4. Starters 1.0 (gelés — 44)

La liste pédagogique est **figée** : 44 starters, numérotés de 1 à 44,
...
users-core-auth, video-detail, video-list, video-playback, video-upload, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
