...
## 4. Starters 1.0 (gelés — 43)

La liste pédagogique est **figée** : 43 starters, numérotés de 1 à 43,
...
users-core-auth, video-detail, video-list, video-upload, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
