...
## 4. Starters 1.0 (gelés — 37)

La liste pédagogique est **figée** : 37 starters, numérotés de 1 à 37,
...
iot-api, iot-contract, iot-dashboard, iot-device, iot-events, iot-simulate, iot-welcome,
