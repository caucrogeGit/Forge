...
## 4. Starters 1.0 (gelés — 38)

La liste pédagogique est **figée** : 38 starters, numérotés de 1 à 38,
...
iot-api, iot-contract, iot-dashboard, iot-device, iot-events, iot-simulate,
iot-subscriber, iot-welcome,
