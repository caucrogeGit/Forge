...
## 4. Starters 1.0 (gelés — 36)

La liste pédagogique est **figée** : 36 starters, numérotés de 1 à 36,
...
iot-api, iot-dashboard, iot-device, iot-events, iot-simulate, iot-welcome,
