...
## 4. Starters 1.0 (gelés — 51)

La liste pédagogique est **figée** : 51 starters, numérotés de 1 à 51,
...
(`images-welcome`, …) pour `forge-mvc-images` (niveau débutant livré).
...
image-upload, image-variants, images-welcome,
