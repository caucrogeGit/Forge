...
## 4. Starters 1.0 (gelés — 42)

La liste pédagogique est **figée** : 42 starters, numérotés de 1 à 42,
...
users-core-auth, video-detail, video-list, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
