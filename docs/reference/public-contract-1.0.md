...
## 4. Starters 1.0 (gelés — 46)

La liste pédagogique est **figée** : 46 starters, numérotés de 1 à 46,
...
users-core-auth, video-detail, video-list, video-playback, video-probe, video-status, video-upload, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
