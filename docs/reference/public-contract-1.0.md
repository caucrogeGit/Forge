...
## 4. Starters 1.0 (gelés — 45)

La liste pédagogique est **figée** : 45 starters, numérotés de 1 à 45,
...
users-core-auth, video-detail, video-list, video-playback, video-status, video-upload, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
