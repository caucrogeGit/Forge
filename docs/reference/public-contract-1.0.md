...
## 4. Starters 1.0 (gelés — 20)

La liste pédagogique est **figée** : 20 starters, numérotés de 1 à 20,
...
list-records, pagination, query-params, request-debug, server-validation,
