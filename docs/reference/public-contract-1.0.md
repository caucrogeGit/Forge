...
## 4. Starters 1.0 (gelés — 41)

La liste pédagogique est **figée** : 41 starters, numérotés de 1 à 41,
...
users-core-auth, video-list, video-welcome, welcome, welcome-optin-iot, welcome-optin-mfa,
welcome-optin-video
```
