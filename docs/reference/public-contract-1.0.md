...
## 4. Starters 1.0 (gelés — 23)

La liste pédagogique est **figée** : 23 starters, numérotés de 1 à 23,
...
layout-template,
list-records, pagination, query-params, request-debug, server-validation, update-record,
