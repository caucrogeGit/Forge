...
## 4. Starters 1.0 (gelés — 29)

La liste pédagogique est **figée** : 29 starters, numérotés de 1 à 29,
...
```
csrf, delete-record, dynamic-route, file-upload, filter-list, first-crud, first-crud-generated,
