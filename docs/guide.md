...
Forge est un framework web MVC Python avec HTTPS natif, SQL explicite, templates Jinja2 et génération déterministe du modèle. Ce guide part d'une VM Debian vierge et aboutit à un premier projet fonctionnel avec CRUD généré.
...
> Si Forge est déjà installé et configuré sur votre machine, passez directement à la [Partie 2 — Créer votre premier projet](#partie-2--crer-votre-premier-projet).
...
## 4. Cycle de développement standard
