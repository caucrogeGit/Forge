...
`forge starter:list` doit afficher les 21 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 21 starters affichés |
