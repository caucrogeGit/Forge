...
`forge starter:list` doit afficher les 99 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 99 starters affichés |
