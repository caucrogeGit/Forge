...
`forge starter:list` doit afficher les 54 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 54 starters affichés |
