...
`forge starter:list` doit afficher les 51 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 51 starters affichés |
