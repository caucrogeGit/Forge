...
`forge starter:list` doit afficher les 36 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 36 starters affichés |
| `forge starter:build N --dry-run` | plan affiché sans erreur (×36) |
