...
`forge starter:list` doit afficher les 22 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 22 starters affichés |
