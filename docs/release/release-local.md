...
`forge starter:list` doit afficher les 81 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 81 starters affichés |
