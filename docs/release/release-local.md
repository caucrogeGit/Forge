...
`forge starter:list` doit afficher les 48 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 48 starters affichés |
