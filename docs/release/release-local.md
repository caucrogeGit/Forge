...
`forge starter:list` doit afficher les 57 starters sans erreur. C'est la vérification minimale que les ressources sont bien incluses dans la wheel.
...
| `forge starter:list` | 57 starters affichés |
