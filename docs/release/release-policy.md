...
| `forge-mvc-video` | `3 - Alpha` | Module vidéo opt-in (upload, transcodage MP4, lecture en streaming HTTP Range) — squelette (`VIDEO-ROADMAP-OPEN-001`, commande `video:doctor`), pas encore publié sur PyPI |
