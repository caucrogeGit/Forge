...
La série de préversion 1.0 (jusqu'à `1.0.0-rc.2`) est livrée, documentée et fortement testée :
...
| `DOC-15MIN-001` | Tutoriel d'entrée Forge (devenu « Bonjour Forge », voir [Bonjour Forge](../guide/bonjour-forge.md)) |
