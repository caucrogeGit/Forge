...
> **Cette page est un alias.**
> Le document canonique de la charte v2 est `CHARTE_DOC.md` à la racine du dépôt Forge (hors `docs/`, non navigable via ce site, lire directement sur le dépôt).
...
L'adoption formelle de la charte est consignée dans [ADR-007](../adr/007-charter-v2-adoption.md).
