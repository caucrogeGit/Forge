...
Forge est un framework web MVC Python orienté lisibilité, SQL explicite et génération déterministe du modèle. Forge 1.0.0-beta.1 est disponible en bêta publique.
