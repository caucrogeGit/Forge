...
- le cycle HTML : **Request → Router → Controller → View → Response HTML** ;
- le cycle JSON : **Request → Router → Controller → Response JSON** (sans View) ;
- la couche **View** — le template Jinja2 que le contrôleur demande de rendre ;
