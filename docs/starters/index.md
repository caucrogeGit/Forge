...
- [Événements](welcome-events/installation.md) : construire un registre d'événements explicite dans son application, et savoir quand il ne vaut pas son prix, voir aussi le guide [Événements](../features/evenements.md).
