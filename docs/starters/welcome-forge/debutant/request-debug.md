...
??? note "Documentations"
    ...
    |---|---|
    | [L'objet Request](../../../reference/http/request.md) | ce que regroupe `request.data` |
    | [L'objet Response](../../../reference/http/response.md) | la réponse, ici la page de débogage `Response.debug(...)` |
