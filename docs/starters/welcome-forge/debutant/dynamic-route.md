...
??? note "Documentations"
    ...
    |---|---|
    | [L'objet Request](../../../core-http/request.md) | les accesseurs de la requête, dont `route(...)` pour les segments de chemin |
    | [L'objet Response](../../../core-http/response.md) | la réponse renvoyée, ici de nouveau en texte brut |
