...
??? note "Documentations"
    ...
    | [L'objet Request](../../../core-http/request.md) | l'accesseur `header(...)`, dont `Authorization` |
    | [L'objet Response](../../../core-http/response.md) | `Response.json(data, status=…)` : données **et** code HTTP |
