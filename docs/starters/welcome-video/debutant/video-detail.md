...
|-------------------|----------------------|-----------|
| `request.route_param` | Lire l'`uuid` dans l'URL. | [Request](../../../reference/api.md#corehttprequest) |
| `VideoRepository.get_by_uuid` | Lire une vidéo précise (ou `None`). | [Parcours vidéo](../../../video/parcours.md) |
